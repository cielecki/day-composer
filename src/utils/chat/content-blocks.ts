...
// API-compatible content block types (thinking blocks must have signature)
export type APIContentBlock = 
	| TextBlock
	| (ThinkingBlock & { signature: string })
	| RedactedThinkingBlock
	| Omit<ToolUseBlock, 'isProcessing'>
	| Omit<ToolResultBlock, 'navigation_targets' | 'is_complete' | 'current_label'>
	| ImageBlock;

/**
 * Cleans and formats content blocks for API consumption
 */
export const formatContentBlocks = (content: ContentBlock[]): APIContentBlock[] => {
	...
	return filterEmptyContentBlocks(cleanedBlocks) as APIContentBlock[];
};
